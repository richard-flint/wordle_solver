...
* Create a new python virtual environment using the requirements.txt file (instructions for how to do this can be found [here](https://docs.python.org/3/library/venv.html))
