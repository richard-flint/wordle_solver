#Import
from backend._2_helper_functions.step_1_generate_next_trial_word import option_1_random_guess as stp1_1
from backend._2_helper_functions.step_1_generate_next_trial_word import option_2_most_frequent_letter as stp1_2
from backend._2_helper_functions.step_1_generate_next_trial_word import option_3_brute_force as stp1_3
...
def generate_next_trial_word(next_word_selection,all_words_remaining,n_words_remaining,all_possible_letters_remaining,mode):
    ...
    #Print trial word
    #If mode=="real_python" (i.e. we are running the wordle solver for real), we need to print out the next
